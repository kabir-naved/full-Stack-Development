      ...
      <div className="pt-10">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="w-full flex">
            <h1 className="text-3xl font-bold mb-4 text-blue-800">Terms of Service for Your Business</h1>
          </div>
          <br />
          ...
          <div className="pb-5">
            <h2 className="font-bold text-blue-700 dark:text-blue-300">General</h2>
            <br />
            <ul>
