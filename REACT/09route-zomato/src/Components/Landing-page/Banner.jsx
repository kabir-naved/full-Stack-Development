...
function Banner() {
  return (
    <>
        <header className="bg-[url('./public/BANNER1.webp')] h-[57vh] bg-cover bg-center">
  <div className="mx-auto max-w-screen-xl py-2 px-4 sm:px-6 lg:px-8">
    <div className="flex h-16 items-center justify-between">
      <div className="flex-1 md:flex md:items-center md:gap-2">
          ...
          <Link className='font-bold text-white'>Get the App</Link>
      </div>
      ...
      <div className="md:flex md:items-center md:gap-12">
        <nav aria-label="Global" className="hidden md:block">
          <ul className="flex items-center gap-6 text-sm">
            <li>
              <Link to= '*' className="text-white transition text-lg hover:text-red-600/75" > Investor Relations </Link>
            </li>

            <li>
              <Link to= '*' className="text-white transition text-lg hover:text-red-600/75" > Add Restaurent </Link>
            </li>
          </ul>
        </nav>
        ...
        <div className="flex items-center gap-4">
          <div className="sm:flex sm:gap-4">
            <Link to= 'login'
              className="rounded-md  hover:bg-red-500 active:bg-red-700 px-5 py-2.5 text-lg font-medium text-white shadow">
              Login
            </Link>

            <div className="hidden sm:flex">
              <Link to= 'login'
                className="rounded-md px-5 py-2.5 text-lg font-medium text-white hover:bg-red-500 active:bg-red-700 ">
                Sign up
              </Link>
            </div>
          </div>
          ...
          <div className="block md:hidden">
            <button className="rounded bg-red-500 p-2 text-white transition hover:text-gray-600">
              <svg
    ...
    <div className='mt-8'>
        <div className='flex justify-center'>
            <img className='h-auto max-w-xs' src="./public/ZOMATO-LOGO1.webp" alt="" />
        </div>
        <h1 className='text-center text-white text-4xl font-medium mt-8'>Discover the best food & drinks in Patna</h1>
        <div className="bg-white rounded-md p-2 shadow-lg flex  max-w-30 md:max-w-[800px] m-auto mt-8">
          <input type="text" placeholder="Search" className="px-4 py-2 rounded-l-full w-40 md:w-80 focus:outline-none border-r-2"/>
          <input type="text" placeholder="Search for restaurant, cuisine or a dish" className="px-4 py-2 rounded-l-full w-40 md:w-80 focus:outline-none"/>
        </div>
    </div>
  </div>
</header>
